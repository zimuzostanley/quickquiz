...
class BOSHClient:
    ...
    def request_bosh_session(self):
        ...
        xml_stanza = "<body rid='%s' xmlns='http://jabber.org/protocol/httpbind' to='fiat' xml:lang='en' wait='60' hold='1' window='5' content='text/xml; charset=utf-8' ver='1.6' xmpp:version='1.0' xmlns:xmpp='urn:xmpp:xbosh'/>" % (self.rid)
    ...
    def authenticate_xmpp(self):
        ...
        xml_stanza = "<body rid='%s' xmlns='http://jabber.org/protocol/httpbind' sid='%s'><auth xmlns='urn:ietf:params:xml:ns:xmpp-sasl' mechanism='DIGEST-MD5'/></body>" % (self.rid + 1, self.sid)
        self.send_request(unicode(xml_stanza))

if __name__ == '__main__':
    c = BOSHClient("admin@fiat", "halloween31", "http://localhost:5280/http-bind/")
    c.init_connection()
